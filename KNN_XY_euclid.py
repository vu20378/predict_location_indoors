...
for k in range(1, 20, 1):
    ...
    mse, rmse, mae, r2, acc, predictions = knn.score(X_test, y_test, save_predictions=True, predictions_path=f'/content/drive/MyDrive/NCKH_K16/predictions_knn_xy_3T_k_{k}.csv')
...
results_df.to_csv('/content/drive/MyDrive/NCKH_K16/resultsknn_xy_3T.csv', index=False)